...
function Finance () {
    ...
    const [coinbaseArticle, setCoinbase] = useState(false);
    const [piArticle, setPi] = useState(false);
    const [cashappArticle, setCashapp] = useState(false);
    ...
    const toggleCoinbase = () => {
        setCoinbase(!coinbaseArticle);
    };
    const togglePi = () => {
        setPi(!piArticle);
    };
    const toggleCashapp = () => {
        setCashapp(!cashappArticle);
    };
    ...
    return (
        <div>
            <span className='finance-body'>
                ...
                <div id="robinhood" className={`hamburger ${robinhoodArticle ? 'change' : ''}`} onClick={() => { rotateHamburger('robinhood'); toggleRobinhood();}}>
            ...
            <span className='finance-body'>
                ...
                <div id="webull" className={`hamburger ${webullArticle ? 'change' : ''}`} onClick={() => { rotateHamburger('webull'); toggleWebull();}}>
                    <hr className="hr1" id="webull-selector"/>
                    <hr className="hr2"/>
                    <hr className="hr3"/>
                </div> 
            </span>
            <article className={`finance-article ${webullArticle ? 'visible' : ""}`} >
            ...
            <span className='finance-body'>
                ...
                <div id="coinbase" className={`hamburger ${coinbaseArticle ? 'change' : ''}`} onClick={() => {rotateHamburger('coinbase'); toggleCoinbase();}} >
                    <hr className="hr1" id="coinbase-selector"/>
                    <hr className="hr2"/>
                    <hr className="hr3"/>
                </div>
            </span>
            <article id='coinbase-hamburger' className={`finance-article ${coinbaseArticle ? 'visible' : ""} `}>
            ...
            <span className='finance-body'>
                ...
                <div id="pi" className={`hamburger ${piArticle ? 'change' : ''}`} onClick={() => {rotateHamburger('pi'); togglePi();}}>
                    <hr className="hr1" id="pi-selector"/>
                    <hr className="hr2"/>
                    <hr className="hr3"/>
                </div>
            </span>
            <article className={`finance-article ${piArticle ? 'visible' : ''} `} >
            ...
            <span className='finance-body'>
                ...
                <div id='cashapp' className={`hamburger ${cashappArticle ? 'change' : ''}`} onClick={() => {rotateHamburger('cashapp'); toggleCashapp(); } }>
                    <hr className="hr1" id="cashapp-selector"/>
                    <hr className="hr2"/>
                    <hr className="hr3"/>
                </div>
            </span>
            <article className={`finance-article ${cashappArticle ? 'visible' : ''} `} >
                <p className="finance-paragraph">Signup to Cashapp and get $5 with my referral link.</p>
                <hr className="finance-hr"/>
                <ul>
                    <li>Try Cash App using my code, and we’ll both get $5 when you link a new bank account and send $5!</li>
                    <li>If you already have a cashapp account and need to send me money or request, my cashapp account is:<b> $adanvivero.</b></li>
                </ul>
            </article>    
            <span className='finance-body'>
                <span className='venmo-span'>
