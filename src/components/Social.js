    ...
    return (
        <div>
            ...
            */} 
            ...
            <span className="social-media-body">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#0000ff" className="bi bi-telegram telegram-icon" viewBox="0 0 16 16">
            ...
            <div className="social-media-body">
                <svg className="vsco-icon" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#ffffff" viewBox="0 0 32 32"> 
